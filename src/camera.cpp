...
// // take photograph
// void take_photograph(struct cudaGraphicsResource* cuda_pbo_resource, int img_number)
// {
//     // get file size
//     size_t fb_size = WIDTH * (HEIGHT/2) * sizeof(uchar4);
...
//     std::string file = "fractal_img_";
//     file.append(std::to_string(img_number));
//     file.append(".bmp");
//     stbi_flip_vertically_on_write(1);
//     int SUCCESS = stbi_write_bmp(file.c_str(), WIDTH, (HEIGHT/2), 4, h_fb);
//     free(h_fb);
// }
...
void Camera::keypress_callback(int key, int action)
{
    if (action == GLFW_PRESS)
    {
        ...
        case GLFW_KEY_Z:
        {
            ...
            // // take a photograph
            // take_photograph(cuda_pbo_resource, last_saved + 1);
