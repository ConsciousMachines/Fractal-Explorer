...
public:
    ...
    bool is_mapped_pbo = false;
    void take_photograph();
...
private:
    ...
    float ROT_AMT = 0.02f; // how fast we rotate
    enum MOVE_TYPE { MOVF, MOVB, MOVU, MOVD, MOVR, MOVL, ROTR, ROTL };
    MOVE_TYPE move_type;
    long long frame_number = 0; // how many frames we saved 
};
